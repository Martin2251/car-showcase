      ...
      >
        <div className='relative w-fit z-10'>
          <Listbox.Button className="custom-filter__btn">
            ...
            <Image
            src="/chevron-up-down.svg" width={20} height={20} className='ml-4 object-contain' alt="chevron up and down"/>
          </Listbox.Button>
          <Transition as={Fragment} leave="trainstion ease-in duration-100" leaveTo='opacity-0'>
            <Listbox.Options
